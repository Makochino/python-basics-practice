...
while True:
    floor = int(input("Введите номер этажа(1-5), чтобы я подобрал вам первую свободную команту на нему: "))

    if floor > 0 and floor < 6:
        #добавить цикл for который будет проходить по комнатам 1-4 и выводить номер каждой
